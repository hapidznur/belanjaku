...
// Belanja
import BelanjaTable from "pages/Belanja/List";
import BelanjaOverview from "pages/Belanja/Dashboard";
// import InvoiceAddNew from "pages/Invoices/AddNew";
// import InvoiceOverview from "pages/Invoices/Overview";
...
const authProtectedRoutes: Array<RouteObject> = [
  ...
  // belanja
  { path: "/belanja", component: BelanjaTable },
  { path: "/belanja/overview", component: BelanjaOverview },
];
